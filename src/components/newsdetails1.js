...
export default function NewsDetails1() {
    ...
    const slug = 'hoc-tieng-han-cap-toc';
        ...
        <div className="news-detail-container max-w-4xl mx-auto p-6">
            ...
            <article className="bg-white shadow-lg rounded-lg p-8">
                ...
                <section className="prose prose-lg max-w-none">
                    ...
                    <h3>{t(`news.${slug}.content.section2.subtitle1`)}</h3>
                    <p dangerouslySetInnerHTML={renderHTML(t(`news.${slug}.content.section2.text1`))} />
                    <p dangerouslySetInnerHTML={renderHTML(t(`news.${slug}.content.section2.text2`))} />

                    <h3>{t(`news.${slug}.content.section2.subtitle2`)}</h3>
                    <p dangerouslySetInnerHTML={renderHTML(t(`news.${slug}.content.section2.text3`))} />
                    ...
                    <h3>{t(`news.${slug}.content.section2.subtitle3`)}</h3>
                    <p>{t(`news.${slug}.content.section2.text4`)}</p>
                    <ul className="list-disc pl-6 mb-6">
                        {t(`news.${slug}.content.section2.list2`, { returnObjects: true }).map((item, index) => (
                            <li key={index}>{item}</li>
                        ))}
                    </ul>
                    <p dangerouslySetInnerHTML={renderHTML(t(`news.${slug}.content.section2.text5`))} />
                    ...
                    <h3>{t(`news.${slug}.content.section3.subtitle`)}</h3>
                    <ul className="list-disc pl-6 mb-6">
                        {t(`news.${slug}.content.section3.list`, { returnObjects: true }).map((item, index) => (
                            <li key={index} dangerouslySetInnerHTML={renderHTML(item)} />
                        ))}
                    </ul>
                    ...
                    <p className="text-center">
                        ...
                        >
                            {t(`news.${slug}.content.section3.register`)}
                        </a>
                    </p>
                </section>
