    ...
    return (
        <div className="floating-buttons">
            ...
            <a href="tel:+84903806203">
                <img src="/assets/icons/phone-icon.png" alt="Phone" className="hotline-icon" />
            </a>
